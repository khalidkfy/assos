...
export default {
  mounted() {
    if (this.$route.query.q) {
      ...
      axios
          .get(`api/settings/furniture_cases/show?id=${this.$route.query.q}`,
              {
                headers: {
          ...
          .then((res) => {
            ...
            this.title = "الإعدادات | تعديل حالة أثاث";
          })
          .catch((e) => {
            console.log(e);
          });
  ...
  data() {
    return {
      name: null,
      id: null,
      title: "الإعدادات | إضافة حالة أثاث",
    }
  },
  methods: {
    save() {
      ...
      axios
          .post(
              "api/settings/furniture_cases/store",
              {
                name: this.name,
                id: this.id
              },
