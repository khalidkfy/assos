...
export default {
  mounted() {
    if (this.$route.query.q) {
      ...
      axios
          .get(`api/settings/jobs/show?id=${this.$route.query.q}`,
              {
                headers: {
          ...
          .then((res) => {
            this.name = res.data.job.name;
            this.id = res.data.job.id;
            this.title = "الإعدادات | تعديل وظيفة";
          })
          .catch((e) => {
            console.log(e);
          });
